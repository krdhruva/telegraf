...
replace (
	github.com/Azure/ClusterConfigurationAgent/LogHelper v0.0.0 => ../../Azure/ClusterConfigurationAgent/LogHelper
	github.com/Azure/ClusterConfigurationAgent/Utils v0.0.0 => ../../Azure/ClusterConfigurationAgent/Utils
	...
	sigs.k8s.io/controller-runtime => sigs.k8s.io/controller-runtime v0.3.1-0.20191112050323-21c63cbb41e0
)
